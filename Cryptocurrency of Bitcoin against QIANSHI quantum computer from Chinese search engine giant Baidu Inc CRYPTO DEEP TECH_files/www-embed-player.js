...
c.prototype=b.prototype;a.X=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.Iq=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
ae.prototype.toJSON=function(){var a=this.v;return vd?a:Jd(a,Kd,Ld)};
function ce(a){vd=!0;try{return JSON.stringify(a.toJSON(),de)}finally{vd=!1}}
...
ye.prototype.preventDefault=function(){ye.X.preventDefault.call(this);var a=this.j;a.preventDefault?a.preventDefault():a.returnValue=!1};var Ae="closure_listenable_"+(1E6*Math.random()|0);var Ge=0;function He(a,b,c,d,e){this.listener=a;this.proxy=null;this.src=b;this.type=c;this.capture=!!d;this.Wa=e;this.key=++Ge;this.Ha=this.Ra=!1}
...
;var Me="closure_lm_"+(1E6*Math.random()|0),Ne={},Oe=0;function Pe(a,b,c,d,e){if(d&&d.once)Qe(a,b,c,d,e);else if(Array.isArray(b))for(var f=0;f<b.length;f++)Pe(a,b[f],c,d,e);else c=Re(c),a&&a[Ae]?a.Z(b,c,Qa(d)?!!d.capture:!!d,e):Se(a,b,c,!1,d,e)}
...
function Ye(a){if("number"!==typeof a&&a&&!a.Ha){var b=a.src;if(b&&b[Ae])Le(b.m,a);else{var c=a.type,d=a.proxy;b.removeEventListener?b.removeEventListener(c,d,a.capture):b.detachEvent?b.detachEvent(Ve(c),d):b.addListener&&b.removeListener&&b.removeListener(d);Oe--;(c=Te(b))?(Le(c,a),0==c.i&&(c.src=null,b[Me]=null)):Ie(a)}}}
...
l.sd=function(a){this.i=0;yf(this,2,a)};
l.td=function(a){this.i=0;yf(this,3,a)};
...
Za(Ef,ab);Ef.prototype.name="cancel";function Of(a,b){$e.call(this);this.l=a||1;this.j=b||y;this.o=Xa(this.qd,this);this.s=Date.now()}
Za(Of,$e);l=Of.prototype;l.enabled=!1;l.ba=null;function Pf(a,b){a.l=b;a.ba&&a.enabled?(a.stop(),a.start()):a.ba&&a.stop()}
l.qd=function(){if(this.enabled){var a=Date.now()-this.s;0<a&&a<.8*this.l?this.ba=this.j.setTimeout(this.o,this.l-a):(this.ba&&(this.j.clearTimeout(this.ba),this.ba=null),af(this,"tick"),this.enabled&&(this.stop(),this.start()))}};
...
function og(a){a=(a.i.cookie||"").split(";");for(var b=[],c=[],d,e,f=0;f<a.length;f++)e=Kb(a[f]),d=e.indexOf("="),-1==d?(b.push(""),c.push(e)):(b.push(e.substring(0,d)),c.push(e.substring(d+1)));return{keys:b,values:c}}
...
function Ug(a){if(a.j&&"undefined"!=typeof Ma)if(a.K[1]&&4==Vg(a)&&2==a.getStatus())a.getStatus();else if(a.A&&4==Vg(a))Qf(a.Zb,0,a);else if(af(a,"readystatechange"),a.isComplete()){a.getStatus();a.j=!1;try{if(Wg(a))af(a,"complete"),af(a,"success");else{try{var b=2<Vg(a)?a.B.statusText:""}catch(c){b=""}a.o=b+" ["+a.getStatus()+"]";Qg(a)}}finally{Rg(a)}}}
...
;function Bh(a){var b=this;this.Ua=!1;if(a.Wc){var c;this.ra=null!=(c=a.ra)?c:new yh}c=a.program;a=a.globalName;var d=new Ah;this.j=d.promise;this.od=p((0,y[a].a)(c,function(e,f){Promise.resolve().then(function(){var g;if(null!=(g=b.ra)){var h=zh()-g.o;g.m.i.fb("/client_streamz/bg/fil",h,g.Aa)}d.resolve({yc:e,ld:f})})},!0)).next().value;
this.kd=d.promise.then(function(){})}
...
a.md])})})};
Bh.prototype.dispose=function(){var a;null!=(a=this.ra)&&a.i.gb();this.Ua=!0;this.j.then(function(b){(b=b.ld)&&b()})};
...
;var Xh={ai:"EMBEDDED_PLAYER_MODE_UNKNOWN",Xh:"EMBEDDED_PLAYER_MODE_DEFAULT",Zh:"EMBEDDED_PLAYER_MODE_PFP",Yh:"EMBEDDED_PLAYER_MODE_PFL"},Yh={pq:"WEB_DISPLAY_MODE_UNKNOWN",lq:"WEB_DISPLAY_MODE_BROWSER",nq:"WEB_DISPLAY_MODE_MINIMAL_UI",oq:"WEB_DISPLAY_MODE_STANDALONE",mq:"WEB_DISPLAY_MODE_FULLSCREEN"};function Zh(){this.data_=[];this.i=-1}
...
353,354,355,356,357,358,361,363,364,368,369,370,373,374,375,378,380,381,388,389,403,410,412,429,413,414,415,416,417,418,430,423,424,425,426,427,431,117,439,441];var Qj={cj:0,Ni:1,Ti:2,Ui:4,Zi:8,Vi:16,Wi:32,bj:64,aj:128,Pi:256,Ri:512,Yi:1024,Qi:2048,Si:4096,Oi:8192,Xi:16384};function Rj(a){I.call(this,a)}
r(Rj,I);function Sj(a){I.call(this,a)}
...
var Tj=[1,2];function ok(a){I.call(this,a,-1,pk)}
...
function Rl(a,b,c){c=void 0===c?{}:c;var d={};L("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":L("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||L("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Hq||L("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().Gq:b=tg([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=L("SESSION_INDEX",0),M("pageid_as_header_web")&&(d["X-Goog-PageId"]=L("DELEGATED_SESSION_ID")));return d}
...
var g=void 0!==b?self.indexedDB.open(a,b):self.indexedDB.open(a);var h=c.blocked,k=c.blocking,m=c.pd,q=c.upgrade,t=c.closed,x;g.addEventListener("upgradeneeded",function(u){try{if(null===u.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===g.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");u.dataLoss&&"none"!==u.dataLoss&&sm("IDB_DATA_CORRUPTED",{reason:u.dataLossMessage||"unknown reason",dbName:wm(a)});var A=f(),E=new Zm(g.transaction);
...
function qn(a){function b(){var f,g,h,k,m,q,t,x,u,A;return w(function(E){switch(E.i){case 1:return g=null!=(f=Error().stack)?f:"",ya(E,2),v(E,a.l(a.name,a.options.version,d),4);case 4:h=E.j;for(var F=a.options,O=[],N=p(Object.keys(F.Ga)),R=N.next();!R.done;R=N.next()){R=R.value;var ca=F.Ga[R],W=void 0===ca.Xc?Number.MAX_VALUE:ca.Xc;!(h.i.version>=ca.hb)||h.i.version>=W||h.i.objectStoreNames.contains(R)||O.push(R)}k=O;if(0===k.length){E.u(5);break}m=Object.keys(a.options.Ga);q=h.objectStoreNames();
...
closed:c,pd:c,upgrade:a.options.upgrade};var e=b();a.i=e;return a.i}
...
;var sp=0,tp=Nc?"webkit":Mc?"moz":Kc?"ms":Jc?"o":"";z("ytDomDomGetNextId",B("ytDomDomGetNextId")||function(){return++sp});var Hp={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};
...
Dq.prototype.extractMatchingEntries=function(a){for(var b=[],c=[],d=p(this.store),e=d.next();!e.done;e=d.next()){e=e.value;a:{var f=a;var g=Object.keys(f);g=p(g);for(var h=g.next();!h.done;h=g.next())if(h=h.value,e.keys[h]!==f[h]){f=!1;break a}f=!0}f?(b.push(e.payload),this.i[Eq(e.keys)]--):c.push(e)}this.store=c;a=Fq(this,a);a=p(a);for(c=a.next();!c.done;c=a.next())c=c.value,0<this.i[c]&&Kk(new Q("Transport IMS did not fully extract entries for key:",{sequence:c,Tq:b.length,Sq:this.i[c]}));return b};
...
function hr(a,b,c,d,e){a={retry:!0,onSuccess:c,onError:d,Yb:a,Ea:b,Jq:!!e,headers:{},postBodyFormat:"",postBody:""};M("use_request_time_ms_header")&&(a.headers["X-Goog-Request-Time"]=JSON.stringify(Math.round(P())));return a}
...
a.params){var ca=a.params;if("object"===typeof a.params)for(var W in ca){if(ca[W]){var ob="params."+W,Wa=Lr(ca[W]);g[ob]=Wa;N+=ob.length+Wa.length;if(500<N)break}}else g.params=Lr(ca)}if(m.length)for(var la=0;la<m.length&&!(N=Jr(m[la],"params.context."+la,g,N),500<=N);la++);navigator.vendor&&!g.hasOwnProperty("vendor")&&(g["device.vendor"]=navigator.vendor);var H={message:t,name:x,lineNumber:E,fileName:F,stack:O,params:g,sampleWeight:1},ka=Number(a.columnNumber);isNaN(ka)||(H.lineNumber=H.lineNumber+
":"+ka);if("IGNORED"===a.level)var ea=0;else a:{for(var Be=Fr(),Ce=p(Be.ma),wd=Ce.next();!wd.done;wd=Ce.next()){var na=wd.value;if(H.message&&H.message.match(na.Rq)){ea=na.weight;break a}}for(var up=p(Be.la),Uj=up.next();!Uj.done;Uj=up.next()){var vp=Uj.value;if(vp.callback(H)){ea=vp.weight;break a}}ea=1}H.sampleWeight=ea;for(var wp=p(Ar),Vj=wp.next();!Vj.done;Vj=wp.next()){var Wj=Vj.value;if(Wj.Za[H.name])for(var xp=p(Wj.Za[H.name]),Xj=xp.next();!Xj.done;Xj=xp.next()){var yp=Xj.value,Sg=H.message.match(yp.regexp);
if(Sg){H.params["params.error.original"]=Sg[0];for(var Yj=yp.groups,zp={},xd=0;xd<Yj.length;xd++)zp[Yj[xd]]=Sg[xd+1],H.params["params.error."+Yj[xd]]=Sg[xd+1];H.message=Wj.tb(zp);break}}}H.params||(H.params={});var Ap=Fr();H.params["params.errorServiceSignature"]="msg="+Ap.ma.length+"&cb="+Ap.la.length;H.params["params.serviceWorker"]="false";y.document&&y.document.querySelectorAll&&(H.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));Db("sample").constructor!==
Bb&&(H.params["params.fconst"]="true");window.yterr&&"function"===typeof window.yterr&&window.yterr(H);if(0!==H.sampleWeight&&!Mr.has(H.message)){if("ERROR"===h){Gr.oa("handleError",H);if(M("record_app_crashed_web")&&0===Pr&&1===H.sampleWeight)if(Pr++,M("errors_via_jspb")){var Zj=new qj;D(Zj,1,1);if(!M("report_client_error_with_app_crash_ks")){var Bp=new lj;D(Bp,1,H.message);var Cp=new mj;G(Cp,lj,3,Bp);var Dp=new nj;G(Dp,mj,5,Cp);var Ep=new oj;G(Ep,nj,9,Dp);G(Zj,oj,4,Ep)}var Fp=new Oj;Xd(Fp,qj,20,
Pj,Zj);sr(Fp)}else{var Gp={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};M("report_client_error_with_app_crash_ks")||(Gp.systemHealth={crashData:{clientError:{logMessage:{message:H.message}}}});qm("appCrashed",Gp)}Or++}else"WARNING"===h&&Gr.oa("handleWarning",H);if(M("kevlar_gel_error_routing"))a:{var De=h;if(M("errors_via_jspb")){if(Ur())var Ip=void 0;else{var yd=new ij;D(yd,1,H.stack);H.fileName&&D(yd,4,H.fileName);var Lb=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Lb.length&&(1!==
Lb.length||isNaN(Number(Lb[0]))?2!==Lb.length||isNaN(Number(Lb[0]))||isNaN(Number(Lb[1]))||(D(yd,2,Number(Lb[0])),D(yd,3,Number(Lb[1]))):D(yd,2,Number(Lb[0])));var Ac=new lj;D(Ac,1,H.message);D(Ac,3,H.name);D(Ac,6,H.sampleWeight);"ERROR"===De?D(Ac,2,2):"WARNING"===De?D(Ac,2,1):D(Ac,2,0);var ak=new jj;D(ak,1,!0);Xd(ak,ij,3,kj,yd);var dc=new fj;D(dc,3,window.location.href);for(var Jp=L("FEXP_EXPERIMENTS",[]),bk=0;bk<Jp.length;bk++){var Nv=Jp[bk];Bd(dc);Pd(dc,5,2,!1).push(Nv)}var ck=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");
if(!Bk()&&ck)for(var Kp=p(Object.keys(ck)),Bc=Kp.next();!Bc.done;Bc=Kp.next()){var Lp=Bc.value,dk=new hj;D(dk,1,Lp);dk.setValue(String(ck[Lp]));Zd(dc,4,hj,dk)}var ek=H.params;if(ek){var Mp=p(Object.keys(ek));for(Bc=Mp.next();!Bc.done;Bc=Mp.next()){var Np=Bc.value,fk=new hj;D(fk,1,"client."+Np);fk.setValue(String(ek[Np]));Zd(dc,4,hj,fk)}}var Op=L("SERVER_NAME"),Pp=L("SERVER_VERSION");if(Op&&Pp){var gk=new hj;D(gk,1,"server.name");gk.setValue(Op);Zd(dc,4,hj,gk);var hk=new hj;D(hk,1,"server.version");
hk.setValue(Pp);Zd(dc,4,hj,hk)}var Tg=new mj;G(Tg,fj,1,dc);G(Tg,jj,2,ak);G(Tg,lj,3,Ac);Ip=Tg}var Qp=Ip;if(!Qp)break a;var Rp=new Oj;Xd(Rp,mj,163,Pj,Qp);sr(Rp)}else{if(Ur())var Sp=void 0;else{var Ee={stackTrace:H.stack};H.fileName&&(Ee.filename=H.fileName);var Mb=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Mb.length&&(1!==Mb.length||isNaN(Number(Mb[0]))?2!==Mb.length||isNaN(Number(Mb[0]))||isNaN(Number(Mb[1]))||(Ee.lineNumber=Number(Mb[0]),Ee.columnNumber=Number(Mb[1])):Ee.lineNumber=
Number(Mb[0]));var ik={level:"ERROR_LEVEL_UNKNOWN",message:H.message,errorClassName:H.name,sampleWeight:H.sampleWeight};"ERROR"===De?ik.level="ERROR_LEVEL_ERROR":"WARNING"===De&&(ik.level="ERROR_LEVEL_WARNNING");var Ov={isObfuscated:!0,browserStackInfo:Ee},zd={pageUrl:window.location.href,kvPairs:[]};L("FEXP_EXPERIMENTS")&&(zd.experimentIds=L("FEXP_EXPERIMENTS"));var jk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(!Bk()&&jk)for(var Tp=p(Object.keys(jk)),Cc=Tp.next();!Cc.done;Cc=Tp.next()){var Up=
Cc.value;zd.kvPairs.push({key:Up,value:String(jk[Up])})}var kk=H.params;if(kk){var Vp=p(Object.keys(kk));for(Cc=Vp.next();!Cc.done;Cc=Vp.next()){var Wp=Cc.value;zd.kvPairs.push({key:"client."+Wp,value:String(kk[Wp])})}}var Xp=L("SERVER_NAME"),Yp=L("SERVER_VERSION");Xp&&Yp&&(zd.kvPairs.push({key:"server.name",value:Xp}),zd.kvPairs.push({key:"server.version",value:Yp}));Sp={errorMetadata:zd,stackTrace:Ov,logMessage:ik}}var Zp=Sp;if(!Zp)break a;qm("clientError",Zp)}if("ERROR"===De||M("errors_flush_gel_always_killswitch"))b:if(M("migrate_events_to_ts"))c:{if(M("web_fp_via_jspb")&&
...
H.stack);for(var $p=p(Object.keys(Fe)),lk=$p.next();!lk.done;lk=$p.next()){var aq=lk.value;ec.postParams["client."+aq]=Fe[aq]}var mk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(mk)for(var bq=p(Object.keys(mk)),nk=bq.next();!nk.done;nk=bq.next()){var cq=nk.value;ec.postParams[cq]=mk[cq]}var dq=L("SERVER_NAME"),eq=L("SERVER_VERSION");dq&&eq&&(ec.postParams["server.name"]=dq,ec.postParams["server.version"]=eq)}jl(L("ECATCHER_REPORT_HOST","")+"/error_204",ec)}try{Mr.add(H.message)}catch(rx){}Nr++}}}}
...
function Xr(a){a=p(a.register.values());for(var b=a.next();!b.done;b=a.next())b.value.Wq("ABORTED")}
...
return a.join("")}
;var as=y.ytLoggingDocDocumentNonce_;as||(as=$r(),z("ytLoggingDocDocumentNonce_",as));var bs=as;var cs={Mh:0,le:1,we:2,Hl:3,Oh:4,aq:5,xm:6,ko:7,Dn:8,Vn:9,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS",9:"RICH_GRID_WATCH"};function ds(a){this.i=a}
...
;var qs={ke:3611,vd:27686,wd:85013,xd:23462,zd:157557,Ad:42016,Bd:62407,Cd:26926,yd:43781,Dd:51236,Ed:79148,Fd:50160,Gd:77504,Sd:153587,Td:87907,Ud:18630,Vd:54445,Wd:80935,Xd:152172,Yd:105675,Zd:150723,ae:37521,be:147285,ce:47786,de:98349,ee:123695,ge:6827,he:29434,ie:7282,je:124448,ne:32276,me:76278,oe:147868,pe:147869,qe:93911,re:106531,se:27259,te:27262,ue:27263,xe:21759,ye:27107,ze:62936,Ae:49568,Be:38408,Ce:80637,De:68727,Ee:68728,Fe:80353,Ge:80356,He:74610,Ie:45707,Je:83962,Ke:83970,Le:46713,
fq:154430,gq:17736,hq:3832,iq:147111,jq:55759,kq:64031,qq:93044,rq:93045,sq:34388,tq:17657,uq:17655,wq:39579,xq:39578,yq:77448,zq:8196,Aq:11357,Bq:69877,Cq:8197,Dq:156512,Eq:156509,Fq:82039};function rs(){var a=vb(ss),b;return(new xf(function(c,d){a.onSuccess=function(e){bl(e)?c(new ts(e)):d(new us("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
function bt(a,b,c,d){d=void 0===d?!1:d;if(-1<c.indexOf(b))throw Error("Deps cycle for: "+b);if(a.i.has(b))return a.i.get(b);if(!a.providers.has(b)){if(d)return;throw Error("No provider for: "+b);}d=a.providers.get(b);c.push(b);if(d.oc)var e=d.oc;else if(d.ud)e=d[Xs]?ct(a,d[Xs],c):[],e=d.ud.apply(d,ia(e));else if(d.nc){e=d.nc;var f=e[Xs]?ct(a,e[Xs],c):[];e=new (Function.prototype.bind.apply(e,[null].concat(ia(f))))}else throw Error("Could not resolve providers for: "+b);c.pop();d.dr||a.i.set(b,e);
return e}
...
p(Object.entries(A));for(var O=F.next();!O.done;O=F.next()){var N=p(O.value),R=N.next().value,ca=N.next().value;A=R;E=ca;d=void 0;null==(d=g.adSignalsInfo.params)||d.push({key:A,value:""+E})}}catch(ob){Sr(ob)}F=g}else Sr(Error("Error: No InnerTubeContext shell provided in ytconfig.")),F={};F={context:F};if(O=this.i(a)){this.j(F,O,b);var W;b="/youtubei/v1/"+jt(this.l());(O=null==(W=ys(a.commandMetadata,cj))?void 0:W.apiUrl)&&(b=O);W=b;(b=L("INNERTUBE_HOST_OVERRIDE"))&&(W=String(b)+String(pc(W)));b=
...
function nu(){var a=document;if("visibilityState"in a)a=a.visibilityState;else{var b=tp+"VisibilityState";a=b in a?a[b]:void 0}switch(a){case "hidden":return 0;case "visible":return 1;case "prerender":return 2;case "unloaded":return 3;default:return-1}}
...
function Au(a){var b={signalServiceEndpoint:{signal:"GET_DATASYNC_IDS"}};var c=void 0===c?Ns:c;var d=Ws(b,a.o);if(!d)return Cf(new Q("Error: No request builder found for command.",b));var e=d.o(b,void 0,c);return e?new xf(function(f){var g,h,k;return w(function(m){if(1==m.i){h="cors"===(null==(g=e.ta)?void 0:g.mode)?"cors":void 0;if(a.m.nd){var q=e.config,t;q=null==q?void 0:null==(t=q.Pa)?void 0:t.sessionIndex;t=Ms({sessionIndex:q});k=Object.assign({},Bu(h),t);return m.u(2)}return v(m,Cu(e.config,
h),3)}2!=m.i&&(k=m.j);f(Du(a,e,k));m.i=0})}):Cf(new Q("Error: Failed to build request for command.",b))}
function Eu(a,b,c){var d;if(b&&!(null==b?0:null==(d=b.Zq)?0:d.er)&&a.l){d=p(wu);for(var e=d.next();!e.done;e=d.next())e=e.value,a.l[e]&&a.l[e].handleResponse(b,c)}}
function Du(a,b,c){var d,e,f,g,h,k,m,q,t,x,u,A,E,F,O,N,R,ca,W,ob,Wa,la,H,ka,ea,Be,Ce,wd;return w(function(na){switch(na.i){case 1:na.u(2);break;case 3:if((d=na.j)&&!d.isExpired())return na.return(Promise.resolve(d.i()));case 2:if(null==(e=b)?0:null==(f=e.ga)?0:f.context)for(g=p([]),h=g.next();!h.done;h=g.next())k=h.value,k.Vq(b.ga.context);if(null==(m=a.j)||!m.br(b.input,b.ga)){na.u(4);break}return v(na,a.j.Qq(b.input,b.ga),5);case 5:return q=na.j,M("kevlar_process_local_innertube_responses_killswitch")||
Eu(a,q,b),na.return(q);case 4:return(u=null==(x=b.config)?void 0:x.Aa)&&a.i.has(u)&&M("web_memoize_inflight_requests")?t=a.i.get(u):(A=JSON.stringify(b.ga),O=null!=(F=null==(E=b.ta)?void 0:E.headers)?F:{},b.ta=Object.assign({},b.ta,{headers:Object.assign({},O,c)}),N=Object.assign({},b.ta),"POST"===b.ta.method&&(N=Object.assign({},N,{body:A})),(null==(R=b.config)?0:R.Yc)&&Z(b.config.Yc),ca=function(){return a.N.fetch(b.input,N,b.config)},t=ca(),u&&a.i.set(u,t)),v(na,t,6);
case 6:W=na.j;if(M("web_one_platform_error_handling")&&(null==(ob=W)?0:null==(Wa=ob.error)?0:Wa.details))for(la=W.error.details,H=p(la),ka=H.next();!ka.done;ka=H.next())ea=ka.value,(Be=ea["@type"])&&-1<xu.indexOf(Be)&&(delete ea["@type"],W=ea);u&&a.i.has(u)&&a.i.delete(u);(null==(Ce=b.config)?0:Ce.Zc)&&Z(b.config.Zc);if(W||null==(wd=a.j)||!wd.Kq(b.input,b.ga)){na.u(7);break}return v(na,a.j.Pq(b.input,b.ga),8);case 8:W=na.j;case 7:return Eu(a,W,b),na.return(W)}})}
...
function Qv(a,b,c,d){a.state=5;try{var e=new Bh({program:b,globalName:c,Wc:M("att_web_record_metrics")});e.kd.then(function(){a.state=6;d&&d(b)});
a.zb(e)}catch(f){a.state=7,f instanceof Error&&Tr(f)}}
l.invoke=function(a){a=void 0===a?{}:a;var b=this.pb();if(b){var c={Nb:a};if(b.Ua)throw Error("Already disposed");a=zh();var d;null!=(d=b.ra)&&d.j.i.Cb("/client_streamz/bg/fsc",d.Aa);d=b.od([c.Nb,c.md]);null!=(b=b.ra)&&(a=zh()-a,b.l.i.fb("/client_streamz/bg/fsl",a,b.Aa));b=d}else b=null;return b};
l.dispose=function(){this.Db()};
l.Db=function(){this.zb(null);this.state=8};
l.pb=function(){return this.i};
l.zb=function(a){oe(this.i);this.i=a};function Rv(){Mv.apply(this,arguments)}
r(Rv,Mv);Rv.prototype.Db=function(){this.state=8};
Rv.prototype.pb=function(){return B("yt.abuse.playerAttLoader")};
Rv.prototype.zb=function(a){oe(B("yt.abuse.playerAttLoader"));z("yt.abuse.playerAttLoader",a)};var Sv=new Rv;var Tv=new Mv;function Uv(){return M("use_player_abuse_bg_library")?Sv.isInitialized():Tv.isInitialized()}
...
;function tw(a){kw.call(this);this.listeners=[];this.api=a;this.addEventListener("onReady",this.onReady.bind(this));this.addEventListener("onVideoProgress",this.gd.bind(this));this.addEventListener("onVolumeChange",this.hd.bind(this));this.addEventListener("onApiChange",this.bd.bind(this));this.addEventListener("onPlaybackQualityChange",this.dd.bind(this));this.addEventListener("onPlaybackRateChange",this.ed.bind(this));this.addEventListener("onStateChange",this.fd.bind(this));this.addEventListener("onWebglSettingsChanged",
this.jd.bind(this))}
r(tw,kw);l=tw.prototype;
...
d[2];break b}d=null}e.videoId=d;e=rw(e);break;case "loadPlaylist":case "cuePlaylist":e=sw(d[0],d[1],d[2],d[3])}b.length=1;b[0]=e}this.api.handleExternalCall(a,b,c);qw(a)&&mw(this,this.nb())}};
l.onReady=function(){var a=this.Ic.bind(this);this.i.j=a;a=this.api.getVideoData();if(!a.isPlayable){a=a.errorCode;var b=void 0===b?5:b;this.sendMessage("onError",(a?ow[a]||b:b).toString())}};
...
l.fd=function(a){a={playerState:a,currentTime:this.api.getCurrentTime(),duration:this.api.getDuration(),videoData:this.api.getVideoData(),videoStartBytes:0,videoBytesTotal:this.api.getVideoBytesTotal(),videoLoadedFraction:this.api.getVideoLoadedFraction(),playbackQuality:this.api.getPlaybackQuality(),availableQualityLevels:this.api.getAvailableQualityLevels(),currentTimeLastUpdated_:Date.now()/1E3,playbackRate:this.api.getPlaybackRate(),mediaReferenceTime:this.api.getMediaReferenceTime()};this.api.getVideoUrl&&
...
l.dd=function(a){mw(this,{playbackQuality:a})};
l.ed=function(a){mw(this,{playbackRate:a})};
l.bd=function(){for(var a=this.api.getOptions(),b={namespaces:a},c=0,d=a.length;c<d;c++){var e=a[c],f=this.api.getOptions(e);b[e]={options:f};for(var g=0,h=f.length;g<h;g++){var k=f[g],m=this.api.getOption(e,k);b[e][k]=m}}this.sendMessage("apiInfoDelivery",b)};
l.hd=function(){mw(this,{muted:this.api.isMuted(),volume:this.api.getVolume()})};
l.gd=function(a){a={currentTime:a,videoBytesLoaded:this.api.getVideoBytesLoaded(),videoLoadedFraction:this.api.getVideoLoadedFraction(),currentTimeLastUpdated_:Date.now()/1E3,playbackRate:this.api.getPlaybackRate(),mediaReferenceTime:this.api.getMediaReferenceTime()};this.api.getProgressState&&(a.progressState=this.api.getProgressState());mw(this,a)};
l.jd=function(){var a={sphericalProperties:this.api.getSphericalProperties()};mw(this,a)};
l.dispose=function(){kw.prototype.dispose.call(this);for(var a=0;a<this.listeners.length;a++){var b=this.listeners[a];this.api.removeEventListener(b.eventType,b.listener)}this.listeners=[]};function uw(a){J.call(this);this.j={};this.started=!1;this.connection=a;this.connection.subscribe("command",this.dc,this)}
...
l.addListener=function(a){if(!(a in this.j)){var b=this.cd.bind(this,a);this.j[a]=b;this.addEventListener(a,b)}};
l.cd=function(a,b){this.started&&!this.i()&&this.connection.va(a,this.mb(a,b))};
...
l.D=function(){var a=this.connection;a.i()||ui(a.j,"command",this.dc,this);this.connection=null;for(var b in this.j)this.j.hasOwnProperty(b)&&this.removeListener(b);J.prototype.D.call(this)};function xw(a,b){uw.call(this,b);this.api=a;this.start()}
...
xw.prototype.D=function(){uw.prototype.D.call(this);delete this.api};function yw(a){a=void 0===a?!1:a;J.call(this);this.j=new K(a);qe(this,this.j)}
...
zw.prototype.D=function(){this.destination=this.l=null;yw.prototype.D.call(this)};function Aw(a,b,c){J.call(this);this.destination=a;this.origin=c;this.j=kq(window,"message",this.l.bind(this));this.connection=new zw(this,a,b);qe(this,this.connection)}
...
function Ew(a){var b=Fw(a),c=document.getElementById(b),d=c&&xv(c,"loaded");d||c&&!d||(c=Gw(a,b,function(){xv(c,"loaded")||(vv(c),Aq(b),cl(Ya(Bq,b),0))}))}
...
function Fw(a){var b=jf("A");Db("This URL is never added to the DOM");fc(b,new Ob(a,Pb));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+kc(a)}
...
r(Iw,Hw);function Jw(a,b,c,d){J.call(this);var e=this;this.A=b;this.webPlayerContextConfig=d;this.ca=!1;this.api={};this.V=this.s=null;this.L=new K;this.j={};this.R=this.W=this.elementId=this.qa=this.config=null;this.P=!1;this.m=this.G=null;this.ka={};this.Na=["onReady"];this.lastError=null;this.Da=NaN;this.K={};this.Oa=new Iw(this);this.T=0;this.l=this.o=a;qe(this,this.L);Kw(this);Lw(this);qe(this,this.Oa);c?this.T=cl(function(){e.loadNewVideoConfig(c)},0):d&&(Mw(this),Nw(this))}
r(Jw,J);l=Jw.prototype;l.getId=function(){return this.A};
l.loadNewVideoConfig=function(a){if(!this.i()){this.T&&(dl(this.T),this.T=0);var b=a||{};b instanceof Bw||(b=new Bw(b));this.config=b;this.setConfig(a);Nw(this);this.isReady()&&Ow(this)}};
...
function Rw(a){var b=!0,c=Sw(a);c&&a.config&&(a=Tw(a),b=xv(c,"version")===a);return b&&!!B("yt.player.Application.create")}
...
a.P=!0;b?a.G():(Bv(Tw(a),a.G),(b=Xw(a))&&Dw(b),Yw(a)&&!c&&z("yt.player.Application.create",null))}}}
function Sw(a){var b=hf(a.elementId);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.elementId));return b}
function Uw(a){if(!a.i()){var b=Sw(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);if(c){a.P=!1;if(!Ww(a,"html5_remove_not_servable_check_killswitch")){var d;if((null==b?0:b.isNotServable)&&a.config&&(null==b?0:b.isNotServable(null==(d=a.config.args)?void 0:d.video_id)))return}Zw(a)}else a.Da=cl(function(){Uw(a)},50)}}
...
function $w(a,b,c){var d=b[c];return function(){var e=Ja.apply(0,arguments);try{return a.lastError=null,d.apply(b,e)}catch(f){"sendAbandonmentPing"!==c&&(f.params=c,a.lastError=f,Tr(f))}}}
function Kw(a){a.ca=!1;if(a.V)for(var b in a.j)a.j.hasOwnProperty(b)&&a.V(b,a.j[b]);for(var c in a.K)a.K.hasOwnProperty(c)&&dl(Number(c));a.K={};a.s=null;a.V=null;b=a.api;for(var d in b)b.hasOwnProperty(d)&&(b[d]=null);b.addEventListener=function(e,f){a.addEventListener(e,f)};
...
function Lw(a){a.addEventListener("WATCH_LATER_VIDEO_ADDED",function(b){Aq("WATCH_LATER_VIDEO_ADDED",b)});
a.addEventListener("WATCH_LATER_VIDEO_REMOVED",function(b){Aq("WATCH_LATER_VIDEO_REMOVED",b)})}
l.addEventListener=function(a,b){var c=this,d=Qw(this,b);d&&(0<=eb(this.Na,a)||this.j[a]||(b=ax(this,a),this.s&&this.s(a,b)),this.L.subscribe(a,d),"onReady"===a&&this.isReady()&&cl(function(){d(c.api)},0))};
l.removeEventListener=function(a,b){this.i()||(b=Qw(this,b))&&ui(this.L,a,b)};
function Qw(a,b){var c=b;if("string"===typeof b){if(a.ka[b])return a.ka[b];c=function(){var d=Ja.apply(0,arguments),e=B(b);if(e)try{e.apply(y,d)}catch(f){Sr(f)}};
a.ka[b]=c}return c?c:null}
function ax(a,b){var c="ytPlayer"+b+a.A;a.j[b]=c;y[c]=function(d){var e=cl(function(){if(!a.i()){try{a.L.oa(b,null!=d?d:void 0)}catch(h){Tr(new Q("PlayerProxy error when creating global callback",{error:h,event:b,playerId:a.A,data:d}))}var f=a.K,g=String(e);g in f&&delete f[g]}},0);
sb(a.K,String(e))};
return c}
...
l.cancel=function(){this.G&&Hv(Tw(this),this.G);dl(this.Da);this.P=!1};
l.D=function(){Vw(this);if(this.m&&this.config&&this.m.destroy)try{this.m.destroy()}catch(b){Sr(b)}this.ka=null;for(var a in this.j)this.j.hasOwnProperty(a)&&(y[this.j[a]]=null);this.qa=this.config=this.api=null;delete this.o;delete this.l;J.prototype.D.call(this)};
...
function Ww(a,b){if(a.webPlayerContextConfig)var c=a.webPlayerContextConfig.serializedExperimentFlags;else{var d;if(null==(d=a.config)?0:d.args)c=a.config.args.fflags}return"true"===Qk(c||"","&")[b]}
...
;var bx={},cx="player_uid_"+(1E9*Math.random()>>>0);function dx(a,b){var c="player",d=!1;d=void 0===d?!0:d;c="string"===typeof c?hf(c):c;var e=cx+"_"+Ra(c),f=bx[e];if(f&&d)return ex(a,b)?f.api.loadVideoByPlayerVars(a.args||null):f.loadNewVideoConfig(a),f.api;f=new Jw(c,e,a,b);bx[e]=f;Aq("player-added",f.api);re(f,function(){delete bx[f.getId()]});
return f.api}
...
mx(d,b,h)}else mx(d,b)}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var k=void 0===k?{}:k;var m=void 0===m?"":m;var q=void 0===q?window:q;c=q.location;a=vc(a,k)+m;var t=void 0===t?Oh:t;a:{t=void 0===t?Oh:t;for(k=0;k<t.length;++k)if(m=t[k],m instanceof Mh&&m.isValid(a)){t=new Ob(a,Pb);break a}t=void 0}t=t||Sb;if(t instanceof Ob)var x=Qb(t);else{b:if(Eh){try{x=new URL(t)}catch(u){x="https:";break b}x=x.protocol}else c:{x=document.createElement("a");try{x.href=t}catch(u){x=void 0;
...
if(!c.serializedForcedExperimentIds){var d=Vk(window.location.href);d.forced_experiments&&(c.serializedForcedExperimentIds=d.forced_experiments)}fx=dx(a,c);fx.addEventListener("onVideoDataChange",ix);fx.addEventListener("onReady",kx);a=L("POST_MESSAGE_ID","player");L("ENABLE_JS_API")?hx=new tw(fx):L("ENABLE_POST_API")&&"string"===typeof a&&"string"===typeof b&&(gx=new Aw(window.parent,a,b),hx=new xw(fx,gx.connection));Kv();M("ytidb_create_logger_embed_killswitch")||nm();a={};ew||(ew=new dw);ew.install((a.flush_logs=
...
var ox=Ik(function(){su();var a=xl.getInstance(),b=Al(119),c=1<window.devicePixelRatio;if(document.body&&hi(document.body,"exp-invert-logo"))if(c&&!hi(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!hi(d,"inverted-hdpi")){var e=fi(d);gi(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&hi(document.body,"inverted-hdpi")&&ii();if(b!=c){b="f"+(Math.floor(119/31)+1);d=Bl(b)||0;d=c?d|67108864:d&-67108865;0==d?delete wl[b]:(c=d.toString(16),
wl[b]=c.toString());c=!0;M("web_secure_pref_cookie_killswitch")&&(c=!1);b=a.i;d=[];for(var f in wl)d.push(f+"="+encodeURIComponent(String(wl[f])));tl(b,d.join("&"),63072E3,a.j,c)}dv.i||(dv.i=new dv);a=dv.i;f=16623;var g=void 0===g?{}:g;Object.values(qs).includes(f)||(Tr(new Q("createClientScreen() called with a non-page VE",f)),f=83769);g.isHistoryNavigation||a.i.push({rootVe:f,key:g.key||""});a.o=[];a.I=[];g.Pb?gv(a,f,g):hv(a,f,g)}),px=Ik(function(a){M("embeds_web_enable_dispose_player_if_page_not_cached_killswitch")?
lx():a.persisted||lx()}),qx=Ik(lx);
window.addEventListener?(window.addEventListener("load",ox),window.addEventListener("pagehide",px)):window.attachEvent&&(window.attachEvent("onload",ox),window.attachEvent("onunload",qx));z("yt.abuse.player.botguardInitialized",B("yt.abuse.player.botguardInitialized")||Uv);z("yt.abuse.player.invokeBotguard",B("yt.abuse.player.invokeBotguard")||Vv);z("yt.abuse.dclkstatus.checkDclkStatus",B("yt.abuse.dclkstatus.checkDclkStatus")||Lv);z("yt.player.exports.navigate",B("yt.player.exports.navigate")||nx);
